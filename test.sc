...
behavior Main (){
	...
	c_queue qIn(qSize), qOut(qSize), qKey(qSize), qExpandedKey1(qSize), qExpandedKey2(qSize), qExpandedKey3(qSize), qExpandedKey4(qSize), qExpandedKey5(qSize), qExpandedKey6(qSize), qExpandedKey7(qSize), qExpandedKey8(qSize), qExpandedKey9(qSize), qExpandedKey10(qSize), qExpandedKey11(qSize);
	c_queue q12(qSize), q23(qSize), q34(qSize), q45(qSize), q56(qSize), q67(qSize), q78(qSize), q89(qSize), q910(qSize), q1011(qSize);
	//stimulus and monitor instances
	stimulus stim_inst(qIn, qKey);
	monitor monitor_inst(qOut);
	//key scheduler instance
	keySched128 key_inst(qKey, qExpandedKey1, qExpandedKey2, qExpandedKey3, qExpandedKey4, qExpandedKey5, qExpandedKey6, qExpandedKey7, qExpandedKey8, qExpandedKey9, qExpandedKey10, qExpandedKey11);
	//instances of rounds
	...
	finalRound128  final_inst10(q1011, qExpandedKey11, qOut);
